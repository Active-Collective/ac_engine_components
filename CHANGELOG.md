...
## [2.4.0](https://github.com/Active-Collective/ac_engine_components/compare/v2.4.0...v2.4.0) (2025-08-19)


### Features

* add IFC loader and viewer updates ([9fe3e84](https://github.com/Active-Collective/ac_engine_components/commit/9fe3e84b7de2365323df6e98e9834659b5d211d7))
* adds BCFTopics tutorial ([f7e0d44](https://github.com/Active-Collective/ac_engine_components/commit/f7e0d44f19bc6aedc769ccc78554bbe70dfac969))
* adds BCFTopics tutorial ([474c725](https://github.com/Active-Collective/ac_engine_components/commit/474c725d6175f0bde50483bf1b6d02dd203b73a8))
* allow multi-object selection ([7fe3f4b](https://github.com/Active-Collective/ac_engine_components/commit/7fe3f4b1b1512e6f7bb7969940e7432e2e76b1ef))
* **core:** add clipper config ([edcacbb](https://github.com/Active-Collective/ac_engine_components/commit/edcacbbf60835e75ed2c423c93b3a12807a4290b))
* **core:** add clipper config ([288cb3d](https://github.com/Active-Collective/ac_engine_components/commit/288cb3def42af773a1d9bba8ac8e4013d4047623))
* **core:** add enabled state to components with ui ([1ab0fed](https://github.com/Active-Collective/ac_engine_components/commit/1ab0fed5a17bbd913ea20c3df0afbf1b0697fe65))
* **core:** add enabled state to components with ui ([0a56f67](https://github.com/Active-Collective/ac_engine_components/commit/0a56f67e32fead76fa0af0447055ccca5ba98a0a))
* **core:** add export-import features to config ([640e970](https://github.com/Active-Collective/ac_engine_components/commit/640e970826b6f6f52aaac6cbda8f078563153d93))
* **core:** add export-import features to config ([e1b84e6](https://github.com/Active-Collective/ac_engine_components/commit/e1b84e6d3e2ff149573d54af426ed7fa7a56888c))
* **core:** add grids config ([b49316e](https://github.com/Active-Collective/ac_engine_components/commit/b49316eb0d2c74ddb4b1108118d8bb83b138bc9b))
* **core:** add grids config ([f99e137](https://github.com/Active-Collective/ac_engine_components/commit/f99e13730f31776e3f0f525057ceb6db3377cce9))
* **core:** add minimap config ([9bab42f](https://github.com/Active-Collective/ac_engine_components/commit/9bab42f2be892d020381f8c22b198a756ee6a636))
* **core:** add minimap config ([47f95a3](https://github.com/Active-Collective/ac_engine_components/commit/47f95a38e095388ee7477ae6344d7d2ba5088242))
* **core:** add non-min and min bundle to build ([df6d802](https://github.com/Active-Collective/ac_engine_components/commit/df6d802fa63987db2e3744993160f738d60f574a))
* **core:** add non-min and min bundle to build ([4dfd344](https://github.com/Active-Collective/ac_engine_components/commit/4dfd344451aa1e09e977ba9b8f580c5b52f9f0a2))
* **core:** add optional disabled state to components with ui ([9c2d1d0](https://github.com/Active-Collective/ac_engine_components/commit/9c2d1d07b13f39f4b527741abfc44cb2705b2f85))
* **core:** add optional disabled state to components with ui ([c0f5916](https://github.com/Active-Collective/ac_engine_components/commit/c0f5916bc5f3e32f054687e36102108f472020bf))
* **core:** add section mesh generation component ([9b20905](https://github.com/Active-Collective/ac_engine_components/commit/9b2090567d2b37843c90b3ed230a7579dcf8f9f0))
* **core:** add section mesh generation component ([46ee63e](https://github.com/Active-Collective/ac_engine_components/commit/46ee63e17253c9b1501ce47391164a101ed0e862))
* **core:** add set method to configurator ([72adb1d](https://github.com/Active-Collective/ac_engine_components/commit/72adb1d2f5557478b1342c0d78d913e7c61ed2b9))
* **core:** add set method to configurator ([f2ae396](https://github.com/Active-Collective/ac_engine_components/commit/f2ae39674cd2c68e10af232911b9b43808317b90))
* **core:** adds argument to specify the name of the ifc loaded ([78907ab](https://github.com/Active-Collective/ac_engine_components/commit/78907abf653036feeb8f4e49fd10e68fb516828b))
* **core:** adds argument to specify the name of the ifc loaded ([2a23a2f](https://github.com/Active-Collective/ac_engine_components/commit/2a23a2f16da67bc2607dba57f42da71c02e2b57b))
* **core:** adds better typing for IDS facets ([6f5f39f](https://github.com/Active-Collective/ac_engine_components/commit/6f5f39f45cb90688ee4f9885701c660c7e68fe11))
* **core:** adds better typing for IDS facets ([6995f7a](https://github.com/Active-Collective/ac_engine_components/commit/6995f7a0e881b9b295e311719a3f4b60fe94a0c0))
* **core:** adds IfcPropertiesManager tutorial ([9bd8463](https://github.com/Active-Collective/ac_engine_components/commit/9bd8463bd99b8330a17668202412b6fa98397a0d))
* **core:** adds IfcPropertiesManager tutorial ([f01c475](https://github.com/Active-Collective/ac_engine_components/commit/f01c47518fa0557218d9349e5b9fa8641c00f08e))
* **core:** adds viewpoints example and tutorial ([38d4dde](https://github.com/Active-Collective/ac_engine_components/commit/38d4dde7fff35669091b3c05bdfa2e88ea7dfbcb))
* **core:** adds viewpoints example and tutorial ([153c21b](https://github.com/Active-Collective/ac_engine_components/commit/153c21b70f8593d9dbbbe2056197128a2cb18c49))
* **core:** allow to export / import classifications ([bdb20f5](https://github.com/Active-Collective/ac_engine_components/commit/bdb20f548093f042574f527c73c9df67ce6c4406))
* **core:** allow to export / import classifications ([3346a39](https://github.com/Active-Collective/ac_engine_components/commit/3346a3962024fac981a11500fba06a0c0f8f4e8b))
* **core:** allow to override raycaster mouse position ([81569c4](https://github.com/Active-Collective/ac_engine_components/commit/81569c4562426cee158fc1c419d479149d420090))
* **core:** allow to override raycaster mouse position ([59916b4](https://github.com/Active-Collective/ac_engine_components/commit/59916b431593b9dfe3ae2559911dece3ef49b05d))
* **core:** allows to define a custom name to Classifier.bySpatialStructure ([adb4731](https://github.com/Active-Collective/ac_engine_components/commit/adb4731ed790ff4d09d7c4788a86249ac00dc404))
* **core:** allows to define a custom name to Classifier.bySpatialStructure ([a5d806a](https://github.com/Active-Collective/ac_engine_components/commit/a5d806a1503850a3a5f370c53137cb861cbff325))
* **core:** connect all existing configs with manager ([bb31fb9](https://github.com/Active-Collective/ac_engine_components/commit/bb31fb9fd7989c005fd8da67468f7c06b97a95b1))
* **core:** connect all existing configs with manager ([fde9faa](https://github.com/Active-Collective/ac_engine_components/commit/fde9faa16ded3f8d0ff17c2d2f83afc31e589c15))
* **core:** create event manager ([b9d12b9](https://github.com/Active-Collective/ac_engine_components/commit/b9d12b9e57a38a0fc296ec8ce4ccfa284b0651d1))
* **core:** create event manager ([4bf8ff2](https://github.com/Active-Collective/ac_engine_components/commit/4bf8ff26157bcdb38410bb714d632c1b5ca268a1))
* **core:** IfcRelationsIndexer is between 2 and 5 times faster when processing a model ([2ae2894](https://github.com/Active-Collective/ac_engine_components/commit/2ae2894b56cf1177f86e092ed4585ea56390af8e))
* **core:** IfcRelationsIndexer is between 2 and 5 times faster when processing a model ([3894a5c](https://github.com/Active-Collective/ac_engine_components/commit/3894a5c7f132f1d7b81e13f20261cc8aa215260e))
* **core:** improve configurator second type ([bc458b0](https://github.com/Active-Collective/ac_engine_components/commit/bc458b059d94dc25fc5048df8a0f6dbb8693aaa2))
* **core:** improve configurator second type ([19cc299](https://github.com/Active-Collective/ac_engine_components/commit/19cc299d4ef4b4fef148bcc6a62f72569d8aac17))
* **core:** improve UIElement type ([d5368b6](https://github.com/Active-Collective/ac_engine_components/commit/d5368b6f8c09606c95f97131484c3c65ea8b888c))
* **core:** improve UIElement type ([cc6253b](https://github.com/Active-Collective/ac_engine_components/commit/cc6253bc199e102079cedd5b6e0bb13869a4d13c))
* **core:** make configurator types optional ([3c68cbb](https://github.com/Active-Collective/ac_engine_components/commit/3c68cbb45b53fe315e1e5f1771b18855ca6fa856))
* **core:** make configurator types optional ([b76522e](https://github.com/Active-Collective/ac_engine_components/commit/b76522e539c464454e16dd265e38311f44905482))
* **core:** remove unused coordinate property from ifc settings ([f128aa3](https://github.com/Active-Collective/ac_engine_components/commit/f128aa3491e717a4854dc648b01a1aa377cb9e93))
* **core:** remove unused coordinate property from ifc settings ([2b23f80](https://github.com/Active-Collective/ac_engine_components/commit/2b23f80e3d617aa7fddf66ff3cb696334f101ce5))
* **front:** Add keydown event for Lengthmeasurement ([#466](https://github.com/Active-Collective/ac_engine_components/issues/466)) ([bbead23](https://github.com/Active-Collective/ac_engine_components/commit/bbead23df2f0269efa8e888e91e0885f5bd5aaa7))
* **front:** Add keydown event for Lengthmeasurement ([#466](https://github.com/Active-Collective/ac_engine_components/issues/466)) ([3bfdcbf](https://github.com/Active-Collective/ac_engine_components/commit/3bfdcbf77d19185855a329f15edf181bb267b5db))
* **front:** add non-min and min bundle to build ([2ab5d75](https://github.com/Active-Collective/ac_engine_components/commit/2ab5d75420f06838f4c643c7199ad88b97116835))
* **front:** add non-min and min bundle to build ([2048aac](https://github.com/Active-Collective/ac_engine_components/commit/2048aac10cba7742d14588e372c9b8eead3743de))
* **front:** add remove method to highlighter ([39c7772](https://github.com/Active-Collective/ac_engine_components/commit/39c7772b3cf76605825e3a19a70e231a95f8e4cb))
* **front:** add remove method to highlighter ([1ff19a5](https://github.com/Active-Collective/ac_engine_components/commit/1ff19a50c8c992a0a37ee8f0f539b41b8b04d34a))
* **front:** add streamed properties caching ([c7b8a9c](https://github.com/Active-Collective/ac_engine_components/commit/c7b8a9c3bd6bc2c15e3e3d21fd499073bdde1866))
* **front:** add streamed properties caching ([331bd69](https://github.com/Active-Collective/ac_engine_components/commit/331bd6916e8a6f601516d3e66b372500f927c8af))
* **front:** Add Threashold to onMouseMove to supress small movements ([#467](https://github.com/Active-Collective/ac_engine_components/issues/467)) ([baf4bea](https://github.com/Active-Collective/ac_engine_components/commit/baf4bea31ac349684462652cba83c6097a26ca14))
* **front:** Add Threashold to onMouseMove to supress small movements ([#467](https://github.com/Active-Collective/ac_engine_components/issues/467)) ([b5c8365](https://github.com/Active-Collective/ac_engine_components/commit/b5c836587cac41d6b922c7c2bfac5dcd9201884a))
* **front:** adds event on length measurements deletion ([b3cdfec](https://github.com/Active-Collective/ac_engine_components/commit/b3cdfecc71ca8beb258313baf81224ad3f646b16))
* **front:** adds event on length measurements deletion ([554e3a6](https://github.com/Active-Collective/ac_engine_components/commit/554e3a6a9e2d67d8338dcec7f1757f80651824e0))
* **front:** allow to apply filter to highlight clear ([e3ebfe3](https://github.com/Active-Collective/ac_engine_components/commit/e3ebfe3bbf572b84503b3f4db11fdd455c98bc2a))
* **front:** allow to apply filter to highlight clear ([23bd49f](https://github.com/Active-Collective/ac_engine_components/commit/23bd49f3d701a9cacda6760da062d372c7382970))
* **front:** allow to get bounding boxes of unstreamed items ([af4dc8d](https://github.com/Active-Collective/ac_engine_components/commit/af4dc8d98cf4d5694c5cbf4b16146e769dfedf25))
* **front:** allow to get bounding boxes of unstreamed items ([ba8a389](https://github.com/Active-Collective/ac_engine_components/commit/ba8a389ae11673ab216d615cabe55a13b066810f))
* **front:** allow to use highlighter without color ([c2ade00](https://github.com/Active-Collective/ac_engine_components/commit/c2ade008e885dadc5ac2b4c611cf8fcc27fee6a8))
* **front:** allow to use highlighter without color ([006b4a1](https://github.com/Active-Collective/ac_engine_components/commit/006b4a1c51a241e3451c8eb488440624222189ed))
* **front:** implement fragment geometry splitting ([cf5ce65](https://github.com/Active-Collective/ac_engine_components/commit/cf5ce65701e0482a7287836aa65b46ee5be95563))
* **front:** implement fragment geometry splitting ([9fb76dc](https://github.com/Active-Collective/ac_engine_components/commit/9fb76dcca1f602228bff8bcc936a9c50ee738946))
* **front:** improve highlighter event handling ([13d6c5e](https://github.com/Active-Collective/ac_engine_components/commit/13d6c5e11a87fa415772691230e7b86d8c39bb2b))
* **front:** improve highlighter event handling ([4ddf977](https://github.com/Active-Collective/ac_engine_components/commit/4ddf977b909282cb77e2b0a492544acc8b205d35))
* **front:** improve ifc streamer setvisibiility logic ([72718fc](https://github.com/Active-Collective/ac_engine_components/commit/72718fc89656ad0d2be579b0243c22dcc74998f3))
* **front:** improve ifc streamer setvisibiility logic ([25ee0aa](https://github.com/Active-Collective/ac_engine_components/commit/25ee0aa398cf91543aca20211ababf897f841b5c))
* **front:** parallelize fragment file streaming ([24faf2b](https://github.com/Active-Collective/ac_engine_components/commit/24faf2be81dc001b2786340528170c08b370b531))
* **front:** parallelize fragment file streaming ([c80748f](https://github.com/Active-Collective/ac_engine_components/commit/c80748f863c6568925428606665dcd6d0a361ba4))
* **front:** support multiple test platform components ([8035428](https://github.com/Active-Collective/ac_engine_components/commit/803542888a937fb836013ebafa0b90731bdb732b))
* **front:** support multiple test platform components ([bd31da8](https://github.com/Active-Collective/ac_engine_components/commit/bd31da8b91b310ef4dcd00960717b31864d7e4a8))
* **front:** test platform component ([369c25a](https://github.com/Active-Collective/ac_engine_components/commit/369c25a4b13bccc81c274a9b28d94e5cc30c4902))
* **front:** test platform component ([12b8e93](https://github.com/Active-Collective/ac_engine_components/commit/12b8e93e6475e34ce2d9a9c79a434fbf6d1a3df0))
* harden ifc support ([e74281f](https://github.com/Active-Collective/ac_engine_components/commit/e74281f5deab940b053b1c669dc41b5cca6f946c))
* respect unit origin ([c071492](https://github.com/Active-Collective/ac_engine_components/commit/c071492f9cafde1e668419156779df238f2357b9))
* **viewer:** add multi-object selection and movement ([27ce9b2](https://github.com/Active-Collective/ac_engine_components/commit/27ce9b253dad87ec35061426a6ce72913f337696))
* **viewer:** add multi-object selection and movement ([15031f7](https://github.com/Active-Collective/ac_engine_components/commit/15031f7c666f45c160fc7bf197930878391e7041))
* **viewer:** add ParameterTest banner and unit dimensions ([d8eab0e](https://github.com/Active-Collective/ac_engine_components/commit/d8eab0ee66683d894c24c2867feee3d1c8528655))
* **viewer:** add simple gltf viewer ([86fe348](https://github.com/Active-Collective/ac_engine_components/commit/86fe348429ae3a9ac60234697462d4d919b7bb25))
* **viewer:** add simple gltf viewer ([e0a0e8b](https://github.com/Active-Collective/ac_engine_components/commit/e0a0e8ba1c118a9eab0f659e682f5ab88a819881))
* **viewer:** cache ifc loads and refine dimensions ([b2fdb03](https://github.com/Active-Collective/ac_engine_components/commit/b2fdb03e705f0a1c830e7a99d22688e8f1c03901))
* **viewer:** center handle and separate vertical snap ([8101ccb](https://github.com/Active-Collective/ac_engine_components/commit/8101ccb908d1250efed03bc4a4c14b139443f666))


### Bug Fixes

* **core:** add guard check for disposing simple planes ([9016ca9](https://github.com/Active-Collective/ac_engine_components/commit/9016ca909b3228241ce8af09186447336e9a14ee))
* **core:** add guard check for disposing simple planes ([ca1ef1f](https://github.com/Active-Collective/ac_engine_components/commit/ca1ef1fb3a15fff9566c6cbb7173608938ed36f2))
* **core:** add guard when reading ifc organization ([9ac1d3b](https://github.com/Active-Collective/ac_engine_components/commit/9ac1d3b57ab096a9adf814253d81185ead9681e8))
* **core:** add guard when reading ifc organization ([55494b5](https://github.com/Active-Collective/ac_engine_components/commit/55494b55c683f2aacb1870bce34367d8d75291c2))
* **core:** also load properties on classifier tutorial ([c381a8d](https://github.com/Active-Collective/ac_engine_components/commit/c381a8d1c35bdc584d6922c5bfba04ea99a25e9f))
* **core:** also load properties on classifier tutorial ([e47d497](https://github.com/Active-Collective/ac_engine_components/commit/e47d49740f0fac2d1bc7bbcc8b932bc0c764f038))
* **core:** blob wasn't allowing to generate viewpoint screenshot in NodeJS ([a5dc8e1](https://github.com/Active-Collective/ac_engine_components/commit/a5dc8e14723d6c957d5e6c2224c1c4b4675b1713))
* **core:** blob wasn't allowing to generate viewpoint screenshot in NodeJS ([1b94642](https://github.com/Active-Collective/ac_engine_components/commit/1b9464223c6f27f9069eb5f63fb19c2a47e114aa))
* **core:** correct geometry splits tiling bug ([fd34d5c](https://github.com/Active-Collective/ac_engine_components/commit/fd34d5ce70a72f59d782394ab09804d488136835))
* **core:** correct geometry splits tiling bug ([ac32b51](https://github.com/Active-Collective/ac_engine_components/commit/ac32b51e21d3ee57212208c751e4c0332b2e382d))
* **core:** default topic stage was set to the default priority ([8b66e75](https://github.com/Active-Collective/ac_engine_components/commit/8b66e7568f1cf3dc12f1d7f130abaf27fbcb3f01))
* **core:** default topic stage was set to the default priority ([196da1a](https://github.com/Active-Collective/ac_engine_components/commit/196da1a042665b85fef8a4757b9beb65eb16b512))
* **core:** deletes extension in ifc-property-query export ([4311ac1](https://github.com/Active-Collective/ac_engine_components/commit/4311ac182b4af6f4ee69c51ee6d22cc5246ef7b6))
* **core:** deletes extension in ifc-property-query export ([0b8cd48](https://github.com/Active-Collective/ac_engine_components/commit/0b8cd482625e970bcecefcd439f89e9797ef4b45))
* **core:** error thrown when deleting an entity after its creation ([d8048f9](https://github.com/Active-Collective/ac_engine_components/commit/d8048f9651f543230ef48455d065c8b24baae894))
* **core:** error thrown when deleting an entity after its creation ([eb9e0cd](https://github.com/Active-Collective/ac_engine_components/commit/eb9e0cd1e15a9be8b00de90e085e22038ee489dd))
* **core:** ids facet bounds checking was inverted ([9e86cc6](https://github.com/Active-Collective/ac_engine_components/commit/9e86cc638fbfec6ba94b5267c1205bccdfe60742))
* **core:** ids facet bounds checking was inverted ([2c7461f](https://github.com/Active-Collective/ac_engine_components/commit/2c7461ff5a4d1d783548391e0415a83e937f0474))
* **core:** ids property facet was failing when it doesn't have to ([a71dcbd](https://github.com/Active-Collective/ac_engine_components/commit/a71dcbdcc62479f4107307e38a91300c6a3bc3e3))
* **core:** ids property facet was failing when it doesn't have to ([5786e57](https://github.com/Active-Collective/ac_engine_components/commit/5786e5727c3d4250519e97849690397c86aaddf5))
* **core:** IFC file containing "$" in header fails to load ([#510](https://github.com/Active-Collective/ac_engine_components/issues/510)) ([90cbcbf](https://github.com/Active-Collective/ac_engine_components/commit/90cbcbf3f33676101ccc284f83ac8cf1977f63ed))
* **core:** IFC file containing "$" in header fails to load ([#510](https://github.com/Active-Collective/ac_engine_components/issues/510)) ([c882d13](https://github.com/Active-Collective/ac_engine_components/commit/c882d13612649d2ccf5923a953552460a5be8666))
* **core:** incorrect ids export ([7dbb06c](https://github.com/Active-Collective/ac_engine_components/commit/7dbb06ce060daf8cb4e79a01b092d0e85c3f8937))
* **core:** incorrect ids export ([cb9848a](https://github.com/Active-Collective/ac_engine_components/commit/cb9848acb474149b2bfef3e23817b4315ea50057))
* **core:** make geometry tiler split geometries according to limit ([900cc16](https://github.com/Active-Collective/ac_engine_components/commit/900cc163ea2db8cde3b57706867c4bc41487922b))
* **core:** make geometry tiler split geometries according to limit ([ed12267](https://github.com/Active-Collective/ac_engine_components/commit/ed12267bfef13941d354b34939e178417f0fadd1))
* **core:** make raycaster compatible with thouch screens ([072af30](https://github.com/Active-Collective/ac_engine_components/commit/072af30cc04bf1f99e266c27e77cf2c5c4866572))
* **core:** make raycaster compatible with thouch screens ([4e6676b](https://github.com/Active-Collective/ac_engine_components/commit/4e6676b385fccb0c98f07aa8ae247eee20c86841))
* **core:** make streamer events async, various streaming fixes ([90f4c44](https://github.com/Active-Collective/ac_engine_components/commit/90f4c4497288f1e0387eb82e00209e94617cfe9b))
* **core:** make streamer events async, various streaming fixes ([fd4304f](https://github.com/Active-Collective/ac_engine_components/commit/fd4304fb8855270dfdf70d68ddecf6b57fbbe78e))
* **core:** missing information when importing IDS files ([f801470](https://github.com/Active-Collective/ac_engine_components/commit/f801470236390d1d7724dcb2b70a59e32eae87d2))
* **core:** missing information when importing IDS files ([a40a3cc](https://github.com/Active-Collective/ac_engine_components/commit/a40a3cce1a0995b8fcc4ca0c187a6934b25f8fe0))
* **core:** missing relation between IfcPropertySet and other entities in new definitions ([4c5e84b](https://github.com/Active-Collective/ac_engine_components/commit/4c5e84b346bb5e8974c5ca5bfda1db4798fb5593))
* **core:** missing relation between IfcPropertySet and other entities in new definitions ([938d6a8](https://github.com/Active-Collective/ac_engine_components/commit/938d6a80c6e3abe745509c0f7b7140777da03c15))
* **core:** prevent json stringify limit when exporting classifications ([72c396b](https://github.com/Active-Collective/ac_engine_components/commit/72c396b129a42453d81df28c5f230e562bbdde79))
* **core:** prevent json stringify limit when exporting classifications ([5c2eaa5](https://github.com/Active-Collective/ac_engine_components/commit/5c2eaa52c6f7d7f8f73afa162aa08589a55dc521))
* **core:** Property Facet in IDS throwing error when NominalValue is null ([7bae76b](https://github.com/Active-Collective/ac_engine_components/commit/7bae76b4f6c602b601f979e91506b8a69277d3e1))
* **core:** Property Facet in IDS throwing error when NominalValue is null ([d8d2cdc](https://github.com/Active-Collective/ac_engine_components/commit/d8d2cdc9d598533867e64c55401e930f1dc5c1ab))
* **core:** solve bug when using nested configs ([37cf119](https://github.com/Active-Collective/ac_engine_components/commit/37cf119cc01d16505e0a414d28913ea6aa18ec3f))
* **core:** solve bug when using nested configs ([695b226](https://github.com/Active-Collective/ac_engine_components/commit/695b2260412d12acc8dd6d22da87c8ceebc80a95))
* **core:** solve configurator export bug ([4591659](https://github.com/Active-Collective/ac_engine_components/commit/4591659a7797a1c88a57d1da7797899467a79c22))
* **core:** solve configurator export bug ([4d4df75](https://github.com/Active-Collective/ac_engine_components/commit/4d4df75cb33b9e10ed4df0199e7faee51728d58e))
* **core:** stream remaining geometries ([683f81f](https://github.com/Active-Collective/ac_engine_components/commit/683f81f7538168c17294b664509b84a6e6d12f34))
* **core:** stream remaining geometries ([b61d3a7](https://github.com/Active-Collective/ac_engine_components/commit/b61d3a7ceea2884fb842758e652cb4a7ad35b550))
* **core:** type psets not reviewed on IDS PropertyFacet ([f54fd9a](https://github.com/Active-Collective/ac_engine_components/commit/f54fd9a4229af43b48314e2fb6506a5e996e3cd4))
* **core:** type psets not reviewed on IDS PropertyFacet ([4aff276](https://github.com/Active-Collective/ac_engine_components/commit/4aff2763713c08a8112b349199785e440727383a))
* **core:** world deletes it-self from the worlds list to prevent unused references ([2ffcf8e](https://github.com/Active-Collective/ac_engine_components/commit/2ffcf8e7377d3b16b6d1c23413b972ac85f7563e))
* **core:** world deletes it-self from the worlds list to prevent unused references ([d8598f9](https://github.com/Active-Collective/ac_engine_components/commit/d8598f9771c13732299248abfeba0dbf74cbaab2))
* Documentation Updates engine-components [#459](https://github.com/Active-Collective/ac_engine_components/issues/459) ([#566](https://github.com/Active-Collective/ac_engine_components/issues/566)) ([1290c6f](https://github.com/Active-Collective/ac_engine_components/commit/1290c6f6a47b9811bc14e2360709933e5de51c4f))
* Documentation Updates engine-components [#459](https://github.com/Active-Collective/ac_engine_components/issues/459) ([#566](https://github.com/Active-Collective/ac_engine_components/issues/566)) ([dd9f0d4](https://github.com/Active-Collective/ac_engine_components/commit/dd9f0d490aaafd8ec8ceb40701949f52ba2cbfe2))
* FaceMeasurement for Multiple Models [#533](https://github.com/Active-Collective/ac_engine_components/issues/533) ([#565](https://github.com/Active-Collective/ac_engine_components/issues/565)) ([e99c8dc](https://github.com/Active-Collective/ac_engine_components/commit/e99c8dcbadaa35e0700c8bd0ac9e5df8c1844443))
* FaceMeasurement for Multiple Models [#533](https://github.com/Active-Collective/ac_engine_components/issues/533) ([#565](https://github.com/Active-Collective/ac_engine_components/issues/565)) ([914b449](https://github.com/Active-Collective/ac_engine_components/commit/914b4497604db2cd4129ddca5a4daec938a28906))
* **front:** correct another outliner disposal bug ([f4548d3](https://github.com/Active-Collective/ac_engine_components/commit/f4548d3ce9b57e0538228eeadbf0362506a973ea))
* **front:** correct another outliner disposal bug ([e1a1c72](https://github.com/Active-Collective/ac_engine_components/commit/e1a1c72cdb43afd0195bee18c0e5c5ebcb1bd672))
* **front:** correct outliner disposal ([2989f02](https://github.com/Active-Collective/ac_engine_components/commit/2989f02dbf84e3ba447989420b5d49a46de6a87f))
* **front:** correct outliner disposal ([7c57c46](https://github.com/Active-Collective/ac_engine_components/commit/7c57c467f0fe52d64518584d4105c5fee70c5d9f))
* **front:** correct outliner position in moved models ([7081fb3](https://github.com/Active-Collective/ac_engine_components/commit/7081fb36267474493d4749cf3e0e1062ca5b46b9))
* **front:** correct outliner position in moved models ([20d2c59](https://github.com/Active-Collective/ac_engine_components/commit/20d2c5956b688da83717cfd86faa2f4a25a2631c))
* **front:** correct small bug with filter highlight logic ([aec56a1](https://github.com/Active-Collective/ac_engine_components/commit/aec56a17b988b94da6fd25e19eebc6644f174c2c))
* **front:** correct small bug with filter highlight logic ([0b01f71](https://github.com/Active-Collective/ac_engine_components/commit/0b01f71aea188561000fa6eaf4436ebe32d2238f))
* **front:** more fixes to filter highlight logic ([a05e3bc](https://github.com/Active-Collective/ac_engine_components/commit/a05e3bc2616fca7e2c38bc73b0c8c5f47acb2780))
* **front:** more fixes to filter highlight logic ([1b20e73](https://github.com/Active-Collective/ac_engine_components/commit/1b20e73531f1671c2d3f5dd497da947e28949645))
* **front:** more fixes to highlight logic ([ec8db41](https://github.com/Active-Collective/ac_engine_components/commit/ec8db4112a9b8bcf9bb74cc9c18e5343e456dd75))
* **front:** more fixes to highlight logic ([f5694d1](https://github.com/Active-Collective/ac_engine_components/commit/f5694d1bf1b5205f07557b2c52122a6206b6c870))
* **front:** more fixes to highlight logic ([1d398b7](https://github.com/Active-Collective/ac_engine_components/commit/1d398b7c363c03adbe505fd708d145a871ab3aaa))
* **front:** more fixes to highlight logic ([27e4bc2](https://github.com/Active-Collective/ac_engine_components/commit/27e4bc2a890631cb7c9a2d8a30dec02cfe3a5201))
* **front:** Revert "Use RawShaderMaterial for transparent objects to improve culling ([#532](https://github.com/Active-Collective/ac_engine_components/issues/532))" ([179eb95](https://github.com/Active-Collective/ac_engine_components/commit/179eb954e28ba9c1d5f7409bfd2088309235a76d))
* **front:** Revert "Use RawShaderMaterial for transparent objects to improve culling ([#532](https://github.com/Active-Collective/ac_engine_components/issues/532))" ([4930288](https://github.com/Active-Collective/ac_engine_components/commit/4930288c12d45a9f6a75603fe5601b223fefc293))
* **front:** Update currentPlan of Plans component so it is not always null ([#480](https://github.com/Active-Collective/ac_engine_components/issues/480)) ([7b22444](https://github.com/Active-Collective/ac_engine_components/commit/7b2244445375796119edcbf5866f75397f378a6c))
* **front:** Update currentPlan of Plans component so it is not always null ([#480](https://github.com/Active-Collective/ac_engine_components/issues/480)) ([62f9d25](https://github.com/Active-Collective/ac_engine_components/commit/62f9d251f492ef0940c70af9259968ed78324b75))
* guard optional ui and clone fragments ([883e1f5](https://github.com/Active-Collective/ac_engine_components/commit/883e1f5a16ae4bf5aa4093a89ff1cb4306405488))
* guard thumbnails and controls ([0132515](https://github.com/Active-Collective/ac_engine_components/commit/013251546adf3265587e092ebd983b7bef13adae))
* guard TransformControls attach ([4476e43](https://github.com/Active-Collective/ac_engine_components/commit/4476e43596e288e51f2b2904ed2b2caf60443869))
* Highlighter isSetup # 556 ([#579](https://github.com/Active-Collective/ac_engine_components/issues/579)) ([fc3ec63](https://github.com/Active-Collective/ac_engine_components/commit/fc3ec63e409ed85fd92b3c5cdcbd014d19fbb54e)), closes [#556](https://github.com/Active-Collective/ac_engine_components/issues/556)
* Highlighter isSetup # 556 ([#579](https://github.com/Active-Collective/ac_engine_components/issues/579)) ([6780230](https://github.com/Active-Collective/ac_engine_components/commit/6780230b83f703a5737a55aa7d5715aaa9c37efa)), closes [#556](https://github.com/Active-Collective/ac_engine_components/issues/556)
* improve wasm loading and UI guards ([81ddc22](https://github.com/Active-Collective/ac_engine_components/commit/81ddc225edc6eff387e78b16cab21cb702c70860))
* include glb and ifc in default library ([3c4349e](https://github.com/Active-Collective/ac_engine_components/commit/3c4349e96e4feb623e457fbe6f75a2fc7c070fc0))
* mobile device orthographic camera zoom ([#558](https://github.com/Active-Collective/ac_engine_components/issues/558)) ([8533659](https://github.com/Active-Collective/ac_engine_components/commit/85336598c2312b1b53364ad99f821412ee929d4d))
* mobile device orthographic camera zoom ([#558](https://github.com/Active-Collective/ac_engine_components/issues/558)) ([29ebd0d](https://github.com/Active-Collective/ac_engine_components/commit/29ebd0de11fc5fb53260b95a9e22ca77955e513a))
* robust fragment cloning and nav guard ([be777b6](https://github.com/Active-Collective/ac_engine_components/commit/be777b624b9e57ced4c92d0f3362a8e361576df2))
* stabilise ifc origin and controls ([1805e7f](https://github.com/Active-Collective/ac_engine_components/commit/1805e7fd9a89eb4b76f54b8d7d2640fad178fdd1))
* stabilize duplication and transformcontrols ([79bab39](https://github.com/Active-Collective/ac_engine_components/commit/79bab398123c3a9f2c0e6ecc19454b1587a4ef83))
* stabilize ifc uploads ([896f537](https://github.com/Active-Collective/ac_engine_components/commit/896f537cf676957fed742057302ace1bdf3f40ab))
* stabilize nudge fading and transform controls ([79f55d8](https://github.com/Active-Collective/ac_engine_components/commit/79f55d88098f9ac4b439fccfbfc80a141f1f1e20))
* stabilize transform controls and nudge arrows ([77ff971](https://github.com/Active-Collective/ac_engine_components/commit/77ff971d8969a5029ce5506a6aec54ef703f9df3))
* update fragments dependency version ([369ee85](https://github.com/Active-Collective/ac_engine_components/commit/369ee850c93d1a00d4069e5d3b84a239ed7d7196))
* update fragments dependency version ([d3bcb9b](https://github.com/Active-Collective/ac_engine_components/commit/d3bcb9be3590695fea962458b24f6357701b575b))
* **viewer:** clone cached IFC roots and set wasm path ([0650e52](https://github.com/Active-Collective/ac_engine_components/commit/0650e52266e35641792ccad3056d26e8add527aa))
* **viewer:** dedupe three and constrain translation ([fab64af](https://github.com/Active-Collective/ac_engine_components/commit/fab64afa5b52ac7735ac1edb9ac6408d80df0c27))


### Miscellaneous Chores

* release 2.4.0 ([d67f18e](https://github.com/Active-Collective/ac_engine_components/commit/d67f18e90d7ea33f2fe7625ebb29d5ce4f8f209b))
* release 2.4.0 ([b2e8cf8](https://github.com/Active-Collective/ac_engine_components/commit/b2e8cf89f72b6b1055e2c56e0a35375fa7353846))
